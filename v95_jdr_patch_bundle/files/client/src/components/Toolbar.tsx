      ...
      <div className="h-12 glass border-b border-panel-border flex items-center px-3 gap-2 z-30 relative">
        ...
        {tabletopProfile.isTabletop && (
          <ToolbarButton
            ...
            label={obsidianExporting ? 'Exporting vault…' : 'Obsidian vault'}
            onClick={() => { void handleExportObsidianVault(); }}
            title="Export a markdown companion vault for Obsidian. The graph remains the runtime source of truth."
          />
        )}
