...
import { Sparkles, Castle, Search, Rocket, Users, Dice5, Drama, CloudMoon, Skull, X, PlayCircle, Wrench } from 'lucide-react';
import {
              ...
              <div className="grid gap-2">
                {catalog.settings.map((option) => (
                  <OptionCard
                    ...
                    icon={option.id === 'frontier_fantasy' ? <Castle size={16} /> : option.id === 'occult_city' ? <CloudMoon size={16} /> : <Rocket size={16} />}
                  />
                ))}
              </div>
            </section>
              ...
              <div className="grid gap-2">
                {catalog.casts.map((option) => (
                  <OptionCard
                    ...
                    icon={option.id === 'roadside_cast' ? <Users size={16} /> : option.id === 'investigator_contacts' ? <Search size={16} /> : <Rocket size={16} />}
                  />
                ))}
              </div>
            </section>
              ...
              <div className="grid gap-2">
                {catalog.rules.map((option) => (
                  <OptionCard
                    ...
                    icon={option.id === 'light_narrative' ? <Drama size={16} /> : <Dice5 size={16} />}
                  />
                ))}
              </div>
            </section>
              ...
              <div className="grid gap-2">
                {catalog.tones.map((option) => (
                  <OptionCard
                    ...
                    icon={option.id === 'adventurous_grounded' ? <Sparkles size={16} /> : option.id === 'mystery_pressure' ? <Search size={16} /> : <Skull size={16} />}
                  />
                ))}
              </div>
            </section>
