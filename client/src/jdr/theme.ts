...
export function getTabletopVisualProfile(runtimeSettings?: RuntimeSettings | null): TabletopVisualProfile {
  ...
  if (themeHints.has('space')) variant = 'space';
  else if (themeHints.has('noir') || themeHints.has('intrigue')) variant = 'noir';
  else if (themeHints.has('fantasy') || themeHints.has('ruin')) variant = 'fantasy';
